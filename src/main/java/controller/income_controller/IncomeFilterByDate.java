...
@WebServlet("/income_filter")
public class IncomeFilterByDate extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Income> incomeList = incomeController.filterIncomes(date1);
        ...
        for (Income income : incomeList) {
            ...
            writer.println("<tbody><tr>" + "<td>" + income.getId() + "</td>"
                    + "<td>" + income.getDate() + "</td>"
                    + "<td>" + income.getTime() + "</td>"
                    + "<td>" + income.getRemarks() + "</td>" +
                    "<td>" + income.getCategory() + "</td>" +
                    "<td>" + income.getPaymentMode() + "</td>" +
