...
@WebServlet("/expense_details")
public class GetExpenseDetailsByID extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Expense expenseById = expenseController.getExpenseById(expense_id);
        ...
        writer.println("<tbody> <tr>" + "<td>" + expenseById.getId() + "</td>"
                + "<td>" + expenseById.getDate() + "</td>"
                + "<td>" + expenseById.getTime() + "</td>"
                + "<td>" + expenseById.getRemarks() + "</td>" +
                "<td>" + expenseById.getCategory() + "</td>" +
                "<td>" + expenseById.getPaymentMode() + "</td>" +
                "<td>" + expenseById.getAmount() + "</td>" +
                "</tr>");
